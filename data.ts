 export enum size {
    Demi = "Demi", Short = "Short", Tall = "Tall", Grande= "Grande", Venti ="Venti", Trenta ="Trenta"
}
 export enum Psize {
...
export let coldBeverages: ItemS[] = [
    {
...
export let chickenBurgers: Items[] = [
    {
