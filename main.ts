...
//size function
async function sizeF(sizearg: any, namearg: any, pricearg: any, anyfunc: any) {
    let message: string = `Price of ${sizearg} ${namearg} is Rs ${pricearg}. Do you want to Add to Cart?`
    ...
    // For Starters
        ...
        async function startersMenuF() {
            ...
            // -Starters Frien Wings
                ...
                let message: string = `Price of Fried Wings (04pcs) is Rs ${starters[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // Starters Chicken Quesdilla
                ...
                let message: string = `Price of Chicken Quesdilla is Rs ${starters[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // starters Crispy chicken strips and fries
                ...
                let message: string = `Price of Crispy chicken strips and fries is Rs ${starters[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //starters French Fries
                ...
                let message: string = `Price of French Fries is Rs ${starters[3].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // starters Nuggets (06 pcs)
                ...
                let message: string = `Price of Nuggets (06 pcs) is Rs ${starters[4].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //starters Nuggets (10 pcs)
                ...
                let message: string = `Price of Nuggets (10 pcs) is Rs ${starters[5].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //starters Tender Seekh Kabab
                ...
                let message: string = `Price of Tender Seekh Kabab is Rs ${starters[6].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    //Beef Burgers
        ...
        async function beefBurgersmenuF() {
            ...
            // Beef Burgers Original cheese burger (serving fries)
                ...
                let message: string = `Price of ${beefBurgers[0].name} is Rs ${beefBurgers[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // beef burgers Classic beef burger (serving with fries)
                ...
                let message: string = `Price of ${beefBurgers[1].name} is Rs ${beefBurgers[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // beef burgers Mushroomy swiss burger (serving with fries)
                ...
                let message: string = `Price of ${beefBurgers[2].name} is Rs ${beefBurgers[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    //Chicken Burgers
        ...
        async function chickenBurgersmenuF() {
            ...
            // chicken Burgers Grilled chicken burger (serving with fries)
                ...
                let message: string = `Price of ${chickenBurgers[0].name} is Rs ${chickenBurgers[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // chicken Burger  Crispy chicken burger (serving with fries)
                ...
                let message: string = `Price of ${chickenBurgers[1].name} is Rs ${chickenBurgers[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    // beef steaks
        ...
        async function beefSteakmenuF() {
            ...
            // beef steak Black Peppers Steak (Garlic Rice/Fries)
                ...
                let message: string = `Price of ${beefSteak[0].name} is Rs ${beefSteak[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // beef steak Tarragon Steak (Garlic Rice/Fries) 
                ...
                let message: string = `Price of ${beefSteak[1].name} is Rs ${beefSteak[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // beef steak Mushroom Steak (Garlic Rice/Fries)
                ...
                let message: string = `Price of ${beefSteak[2].name} is Rs ${beefSteak[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    // chicken steaks
        ...
        async function chickenSteakmenuF() {
            ...
            // chicken steak Black Peppers Steak (Garlic Rice/Fries)
                ...
                let message: string = `Price of ${chickenSteak[0].name} is Rs ${chickenSteak[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // chicken steak Tarragon Steak (Garlic Rice/Fries)
                ...
                let message: string = `Price of ${chickenSteak[1].name} is Rs ${chickenSteak[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //chicken Steak 
                ...
                let message: string = `Price of ${chickenSteak[2].name} is Rs ${chickenSteak[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    //salad menu
        ...
        async function saladMenuF() {
            ...
            // salad Chopped Mediterranean Salad 
                ...
                let message: string = `Price of ${salad[0].name} is Rs ${salad[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // salad
                ...
                let message: string = `Price of ${salad[1].name} is Rs ${salad[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    // Pasta menu
        ...
        async function pastaMenuF() {
            ...
            // pasta Frettucino alfredo pasta
                ...
                let message: string = `Price of ${pasta[0].name} is Rs ${pasta[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //pasta "Creamy roasted tomatoes penne pasta (Special)"
                ...
                let message: string = `Price of ${pasta[1].name} is Rs ${pasta[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //pasta "Mac n cheese "
                ...
                let message: string = `Price of ${pasta[2].name} is Rs ${pasta[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            //pasta " Baked penne pasta "
                ...
                let message: string = `Price of ${pasta[3].name} is Rs ${pasta[3].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
    ...
    // sandwiches menu
        ...
        async function sandwichesMenuF() {
            ...
            // sandwiches "Grilled cheese sandwich (serving with fries)"
                ...
                let message: string = `Price of ${sandwiches[0].name} is Rs ${sandwiches[0].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // sandwiches "Grilled chicken sandwich (serving with fries)"
                ...
                let message: string = `Price of ${sandwiches[1].name} is Rs ${sandwiches[1].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // sandwiches "Club sandwich (serving with fries"
                ...
                let message: string = `Price of ${sandwiches[2].name} is Rs ${sandwiches[2].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
            ...
            // sandwiches "Chicken and egg melt (serving with fries)"
                ...
                let message: string = `Price of ${sandwiches[3].name} is Rs ${sandwiches[3].price}. Do you want to Add to Cart?`
                let addtoCart = await inquirer.prompt([{
                    name: "cartPrompt",
                    message: message,
                    type: "list",
        ...
        async function pizzaMenuF() {
            ...
            // pizza Pepperoni pizza
                ...
                // small
                    ...
                    let message: string = `Price of ${pizza[0].small.size} ${pizza[0].name} is Rs ${pizza[0].small.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // regular
                    ...
                    let message: string = `Price of ${pizza[0].regular.size} ${pizza[0].name} is Rs ${pizza[0].regular.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // Large
                    ...
                    let message: string = `Price of ${pizza[0].large.size} ${pizza[0].name} is Rs ${pizza[0].large.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
            ...
            //pizza cheesy pizza
                ...
                // small
                    ...
                    let message: string = `Price of ${pizza[1].small.size} ${pizza[1].name} is Rs ${pizza[1].small.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // regular
                    ...
                    let message: string = `Price of ${pizza[1].regular.size} ${pizza[1].name} is Rs ${pizza[1].regular.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // Large
                    ...
                    let message: string = `Price of ${pizza[1].large.size} ${pizza[1].name} is Rs ${pizza[1].large.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
            ...
            //pizza chicken tikka
                ...
                // small
                    ...
                    let message: string = `Price of ${pizza[2].small.size} ${pizza[2].name} is Rs ${pizza[2].small.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // regular
                    ...
                    let message: string = `Price of ${pizza[2].regular.size} ${pizza[2].name} is Rs ${pizza[2].regular.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
                ...
                // Large
                    ...
                    let message: string = `Price of ${pizza[2].large.size} ${pizza[2].name} is Rs ${pizza[2].large.price}. Do you want to Add to Cart?`
                    let addtoCart = await inquirer.prompt([{
                        name: "cartPrompt",
                        message: message,
                        type: "list",
